...
namespace ETModel {
  ...
  public partial class Movement_Jump : pb::IMessage {
    private static readonly pb::MessageParser<Movement_Jump> _parser = new pb::MessageParser<Movement_Jump>(() => (Movement_Jump)MessagePool.Instance.Fetch(typeof(Movement_Jump)));
    public static pb::MessageParser<Movement_Jump> Parser { get { return _parser; } }
  ...
  public partial class M2C_MovementResult : pb::IMessage {
    private static readonly pb::MessageParser<M2C_MovementResult> _parser = new pb::MessageParser<M2C_MovementResult>(() => (M2C_MovementResult)MessagePool.Instance.Fetch(typeof(M2C_MovementResult)));
    public static pb::MessageParser<M2C_MovementResult> Parser { get { return _parser; } }
